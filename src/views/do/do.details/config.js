...
export const actionConfig = [ // 列表操作配置
  
    
    {
      name: '编辑',
      command: 'edit',
      isShow: (page) => !page.doDetails.invoiceStatus|| [DO.INVOICESTATUS.草稿, DO.INVOICESTATUS.已确认, DO.INVOICESTATUS.已驳回].includes(page.doDetails.invoiceStatus),
      disabled: false
    },
    ...
    
    {
      name: '删除',
      command: 'delete',
      isShow: (page) => !page.doDetails.invoiceStatus || [DO.INVOICESTATUS.草稿].includes(page.doDetails.invoiceStatus),
      isDialog: true,
      disabled: false
    },
